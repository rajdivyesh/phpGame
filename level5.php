...
<div class="content">
    <h1 style="color:Blue;">Level 5</h1>
    <h3>Lives Left : <?php echo $_SESSION['user_lives']; ?></h3>
    <?php 
        if($_SESSION['user_lives']>=1){
            if($_SESSION['result']=="level5"){
                $_SESSION['result']="";
                ?>
                <h3 style="color:Blue;">You pass the Level 5 "Identified First and Last Letter"><br/>
        <a href="level5.php">
            play again Level 5
        </a></br>
        <a href="level6.php">
            Go to Level 6 "Identify first and last number"
        </a></br>
        <a href="index.php">
            <?php
            ...
            ?>
            <h3 style="color:Blue;">Find First & Last Letter of Alphabates:</h3>
            <h2  style="color:red;"><?php $letter_display = random_chars(); echo $letter_display; ?></h2>

            <form method="post" action="level5data.php" id ="gameLevel5">
