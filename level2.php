...
<div class="content">
    ...
    <h1 style="color:Blue;">Level 2</h1>
    ...
    <?php 
        if($_SESSION['user_lives']>=1){
            if($_SESSION['result']=="level2"){
                $_SESSION['result']="";
                ?>
                <h3 style="color:Blue;">You pass the Level 2 "Descending alphabet"><br/>
        <a href="level2.php">
            play again Level 2
        </a></br>
        <a href="level3.php">
        ...
        <a href="index.php">
            ...
            ?>
            <h2 style="color:Blue;">Arrange letters in Descending alphabetical order:</h2>
